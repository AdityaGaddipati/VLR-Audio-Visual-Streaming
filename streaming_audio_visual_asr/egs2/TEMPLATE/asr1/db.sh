...
LRS2=
LRS3=/scratch/karthikg/datasets/lrs3
SUNDA=downloads
...
# Vision Mouth ROI related
face_predictor_path=/work/hkwark/data/misc/shape_predictor_68_face_landmarks.dat
mean_face_path=/work/hkwark/data/misc/20words_mean_face.npy
ffmpeg_path=/work/hkwark/anaconda3/bin/ffmpeg   # Can find by $ which ffmpeg
