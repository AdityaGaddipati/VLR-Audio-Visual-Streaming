...
def main():
    ...
    #     fp_dir = os.path.dirname(face_predictor_path)
    #     wget.download("https://github.com/JeffTrain/selfie/raw/master/shape_predictor_68_face_landmarks.dat", out = fp_dir)

    # if not os.path.exists(mean_face_path):
    #     # !wget --content-disposition https://github.com/mpc001/Lipreading_using_Temporal_Convolutional_Networks/raw/master/preprocessing/20words_mean_face.npy -O /home/hkwark/11877/Streaming_Audio_Visual/baseline/data/misc/20words_mean_face.npy
    #     wget.download("https://github.com/mpc001/Lipreading_using_Temporal_Convolutional_Networks/raw/master/preprocessing/20words_mean_face.npy", out = mean_face_path)
