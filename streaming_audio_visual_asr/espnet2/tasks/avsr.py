...
class AVSRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group = parser.add_argument_group(description="Vision related")

        group.add_argument(
            f"--vision_encoder",
            type=str,
            default="resnet",
            help="Vision Feature Extractor Model to use",
        )

        group.add_argument(
            f"--vision_encoder_conf",
            action=NestedDictAction,
            default=None,
            help="configuration for vision encoder",
        )
